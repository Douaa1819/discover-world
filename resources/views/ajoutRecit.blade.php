...
<div class="flex justify-end">
    <div id="crud-modal" tabindex="-1" aria-hidden="true" class="  flex justify-end overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 items-center w-full md:inset-0 max-h-full">
